                        ...
                        <div class="product-banner-carousel slick-row-10">
                            ...
                            <div class="banner-slide-item">
                                <figure class="banner-statistics">
                                    <a href="#">
                                        <img src="assets/img/banner/anh1.png" alt="product banner">
                                    </a>
                            ...
                            <div class="banner-slide-item">
                                <figure class="banner-statistics">
                                    <a href="#">
                                        <img src="assets/img/banner/anh2.png" alt="product banner">
                                    </a>
                                    <div class="banner-content banner-content_style2">
                            ...
                            <div class="banner-slide-item">
                                <figure class="banner-statistics">
                                    <a href="#">
                                        <img src="assets/img/banner/anh5.png" alt="product banner">
                                    </a>
                                    <div class="banner-content banner-content_style2">
                            ...
                            <div class="banner-slide-item">
                                <figure class="banner-statistics">
                                    <a href="#">
                                        <img src="assets/img/banner/anh6.png" alt="product banner">
                                    </a>
                                    <div class="banner-content banner-content_style2">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <!-- section title start -->
                        <div class="section-title text-center">
                            <h2 class="title">Danh mục sản phẩm áo sơ mi</h2>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="product-carousel-4_2 slick-row-10 slick-arrow-style">
                            <!-- product item start -->
                            <?php foreach($sanPhamAoSoMi as $key=>$sanPham): ?>
                                        <!-- product item start -->
                                        <div class="product-item">
                                            <figure class="product-thumb">
                                                <a href="<?= BASE_URL . "?act=chi-tiet-san-pham&id=".$sanPham['id'];?>">
